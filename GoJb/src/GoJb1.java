...
public class GoJb1 implements ActionListener{
	...
	ImageIcon äpple = new ImageIcon(getClass().getResource("images/1033.png"));
	ImageIcon flinta = new ImageIcon(getClass().getResource("images/1031.png"));
	ImageIcon järnStenTrä = new ImageIcon(getClass().getResource("images/1029.gif"));
	ImageIcon nederstjärna = new ImageIcon(getClass().getResource("images/1020.png"));
